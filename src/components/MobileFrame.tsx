...
const MobileFrame = ({ children }: MobileFrameProps) => {
  return (
    <div className="min-h-screen bg-gradient-to-br from-sage-light via-cream to-blush-light flex items-center justify-center p-4">
      <div className="w-full max-w-[390px] min-h-[844px] bg-background rounded-[3rem] shadow-2xl overflow-hidden relative border-[8px] border-foreground/10 isolate transform-gpu">
        <Toaster />
        {/* Status bar */}
